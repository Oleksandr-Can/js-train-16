...
function filterStudentsByGrade(students, grade) {
  ...
  const filter= students.filter(data => data.grade === grade);
...
function validateUserInput(userInput) {
  ...
  console.assert(userInput.password, "Помилка: ім'я користувача відсутнє!");
...
function calculateTotalPrice(products) {
  ...
  total = products.reduce((accum, goods) => accum + goods.price, 0)
...
console.log(`голосних: ${i}`)
console.log(`приголосних: ${j}`)
